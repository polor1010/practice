...
def main():
    ...
    #pretrained_dict = model.load_state_dict('./mnist_cnn.pt', map_location=torch.device('cpu'))

    #pretrained_dict=model2['state_dict']
    ...
    print("Model's same state_dict:")
    for param_tensor in model2.state_dict():
        print(param_tensor, "\t", model2_dict[param_tensor].size())
        print(param_tensor, "\t", model2_dict[param_tensor])
